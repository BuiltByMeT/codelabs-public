...
class LemonadeTests : BaseTest() {
    ...
    fun `test_initial_state`() {
        testState(R.string.lemonade_state_pick, R.drawable.lemon_tree)
    }
    ...
    fun `test_picking_lemon_proceeds_to_squeeze_state`() {
        ...
        testState(R.string.lemonade_state_squeeze, R.drawable.lemon_squeeze)
    }
    ...
    fun `test_squeezing_lemon_proceeds_to_drink_state`() {
        ...
        onView(withId(R.id.image_lemon_state)).perform(click())
        juiceLemon()
        testState(R.string.lemonade_state_drink, R.drawable.lemon_drink)
    }
    ...
    fun `test_drinking_juice_proceeds_to_restart_state`() {
        ...
        onView(withId(R.id.image_lemon_state)).perform(click())
        // Click image to progress state
        testState(R.string.lemonade_state_restart, R.drawable.lemon_restart)
    }
